...
<div id="main">
	...
	<div class="bar">
		...
		<form action="showServlet">
				<input type="submit" name="show" value="Show all Enquiries" style="margin:30px 0 -40px 39%;padding:5px 9px 5px 9px;background-color:#8e8eff; font-size:30px;">
		</form>
	<div id="form">
		<h1>Enquiry form :</h1>
		<form action="enquiryDone">
			...
			<input type="submit" class="btn" value="Proceed to Enquiry">
		</form>
	</div>
