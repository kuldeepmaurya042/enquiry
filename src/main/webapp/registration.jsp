...
<div id="main">
	...
	<div class="bar">
		...
		<form action="showServlet">
				<input type="submit" name="show" value="Show all Registrations" style="margin:30px 0 -40px 37%;padding:5px 9px 5px 9px;background-color:#8e8eff; font-size:30px;">
		</form>
	...
	<div id="form">
		...
		<form action="registrationDone">
			...
			<input type="submit" class="btn" value="Register to Course">
		</form>
	</div>
